...
export const INITIAL_ARTICLES: Article[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p class="mb-4 leading-relaxed text-slate-600">
        불법 업체를 찾기 전에 <strong>서민금융진흥원</strong>의 저금리 대출 상품이나 <strong>신용회복위원회</strong>의 채무조정 제도를 먼저 알아보는 것이 순서입니다. 
  ...
  },
  {
    ...
    content: `
      ...
      <p class="mb-6 leading-relaxed">이 대출들은 은행이 직접 개인의 신용을 평가하는 대신, <strong>서울보증보험</strong>이 발급하는 보증서를 담보로 잡습니다. 보증보험사가 개인의 통신비 납부 내역(Telco Score)이나 금융 거래 이력을 바탕으로 "이 사람은 300만 원까지는 갚을 수 있다"고 보증을 서주는 것입니다. 따라서 연체 이력이 있거나 보증 보험 발급이 거절되면 대출이 불가능합니다.</p>
      ...
      <p class="mb-4 leading-relaxed">급했다고 아무 곳에서나 돈을 빌리는 것은 내 미래의 소득을 헐값에 파는 것과 같습니다. 오늘 소개한 1금융권 비상금 대출은 급전이 필요할 때 가장 먼저 고려해야 할 안전한 선택지입니다. 하지만 잊지 마십시오. 아무리 좋은 대출이라도 <strong>상환 계획 없는 빚</strong>은 고통의 시작일 뿐입니다.</p>
    `
  },
  {
    id: '3',
